...
class warehouse_cnt extends Controller
{
    ...
    public function index()
    {
        ...
        return view('warehouse.warehouse_index', ['ware_emp' => $ware_emp, 'task' => $task, 'staffNames' => $staffNames, 'taskCounts' => $taskCounts, 'categoryNames' => $categoryNames, 'categorytaskCounts' => $categorytaskCounts, 'subcategoryNames' => $subcategoryNames, 'subcategorytaskCounts' => $subcategorytaskCounts, 'pendingLeaves' => $pendingLeaves, 'task_ext' => $task_ext,  'tast_ext' => $tast_ext]);
    }
