<div class="empdetails">
    <div class="sidebodyhead">
        <h4 class="m-0">HoldList Details</h4>
    </div>
            ...
            <table class="table table-hover table-striped" id="table3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $ht->skill }}</td>
                        <td>{{ $ht->edu }}</td>
                        <td><a class="listtdbtn" onclick="return confirm('Are You sure to ShortList the Employee ?')"
                                href="{{ route('hold_update', ['round_id' => $ht->round_id]) }}">Active</a>
                        </td>
                    </tr>
                    @endforeach
                @endif
