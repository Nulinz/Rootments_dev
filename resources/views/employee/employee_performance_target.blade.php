...
@section('content')
    ...
    <div class="sidebodydiv px-5 py-3">
        <div class="sidebodyhead">
            <h4 class="m-0">DSR-Rental</h4>
        </div>

        <form action="{{ route('employee.emp_performance_target') }}" method="POST">
            @csrf
            <div class="container-fluid maindiv my-3">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-4 inputs mb-3">
                        <label for="store">Target Qunatity</label>
                        <input type="text" class="form-control" name="target_qty" required>
                    </div>
                    <div class="col-sm-12 col-md-4 col-xl-4 inputs mb-3">
                        <label for="store">Target Value</label>
                        <input type="text" class="form-control" name="target_val" required>
                    </div>
                </div>
            </div>
            ...
            <div class="filter-container row mb-3">
                ...
                <div class="select1 col-sm-12 col-md-4 mx-auto">
                    <div class="d-flex gap-3">
                        <a id="pdfLink"><img src="{{ asset('assets/images/printer.png') }}" id="print" alt="" height="28px" data-bs-toggle="tooltip"
                                data-bs-title="Print"></a>
                        <a id="excelLink"><img src="{{ asset('assets/images/excel.png') }}" id="excel" alt="" height="30px" data-bs-toggle="tooltip"
                ...
                <table id="example" class="table-hover table-striped table">
                    ...
                    <tbody>
                        ...
                        @foreach ($emp_target as $tl)
                            @php
                                $monthName = \Carbon\Carbon::createFromFormat('Y-m', $tl->month)->format('F Y');
                            @endphp
                            <tr>
